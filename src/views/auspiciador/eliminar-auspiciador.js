...
function EliminarAuspiciador() {
    ...
    const obtenerOrg=async(values)=>{
        try{
            ...
            const response=await api.get(`api/distintosA/${values}`)
    ...
    const sendData=async()=>{
        try{
        console.log(jsonout)
        const response=await api.post('/api/quitarAuspiciadores',jsonout)
        ...
        <>
            <div className="crud-container text-center" >
                ...
                <Flex justify-content='center' >
                    <Title>ELIMINAR AUSPICIADORES</Title>
                </Flex>
                            ...
                            <tr key={elemento.id}>
                                ...
                                <Td>
                                    ...
                                    <Modal isOpen={isModalOpen} toggle={toggleModal}>
                                        ...
                                        >AUSPICIADORES A ELIMINAR</ModalHeader>
                                    ...
                                    >
                                        ...
                                        >
                                            SE VAN A ELIMINAR LOS AUSPICIADORES SELECCIONADOS
                                        </ModalBody>
                                        <ModalFooter
                                            style={{
                                                display: 'flex',
                                    ...
                                    >
                                        ...
                                        >
                                            HA OCURRIDO UN ERROR AL ELIMINAR EL O LOS AUSPICIADORES
                                        </ModalBody>
                                        <ModalFooter
                                            style={{
                                                display: 'flex',
