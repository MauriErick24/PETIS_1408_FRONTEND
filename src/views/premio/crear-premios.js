...
function AgregarPremio() {
    ...
    const obtenerOrg=async(values)=>{
        try{
            ...
            const response=await api.get(`api/distintosPA/${values}`)
    ...
    const sendData=async()=>{
        try{
        console.log(jsonout)
        const response=await api.post('/api/asignarPremios',jsonout)
                            ...
                            <tr key={elemento.id}>
                                ...
                                <Td>
                                    ...
                                    >
                                        ...
                                        >
                                            SE VA A AGREGAR LOS PREMIOS SELECCIONADOS
                                        </ModalBody>
                                        <ModalFooter
                                            style={{
                                                display: 'flex',
                                    ...
                                    >
                                        ...
                                        >
                                            HA OCURRIDO UN ERROR AL AGREGAR EL O LOS PREMIOS
                                        </ModalBody>
                                        <ModalFooter
                                            style={{
                                                display: 'flex',
